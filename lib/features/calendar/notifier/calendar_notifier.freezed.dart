...
mixin _$CalendarState {
 ...
 DateTime get selectedDate; List<SmartEvent> get events;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CalendarState&&(identical(other.selectedDate, selectedDate) || other.selectedDate == selectedDate)&&const DeepCollectionEquality().equals(other.events, events));
}


@override
int get hashCode => Object.hash(runtimeType,selectedDate,const DeepCollectionEquality().hash(events));
...
@useResult
$Res call({
 DateTime selectedDate, List<SmartEvent> events
});
...
/// Create a copy of CalendarState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedDate = null,Object? events = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime selectedDate,  List<SmartEvent> events)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CalendarState() when $default != null:
return $default(_that.selectedDate,_that.events);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime selectedDate,  List<SmartEvent> events)  $default,) {final _that = this;
switch (_that) {
case _CalendarState():
return $default(_that.selectedDate,_that.events);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime selectedDate,  List<SmartEvent> events)?  $default,) {final _that = this;
switch (_that) {
case _CalendarState() when $default != null:
return $default(_that.selectedDate,_that.events);case _:
  return null;
...
class _CalendarState extends CalendarState {
   _CalendarState({required this.selectedDate, final  List<SmartEvent> events = const []}): _events = events,super._();
  

@override final  DateTime selectedDate;
 final  List<SmartEvent> _events;
@override@JsonKey() List<SmartEvent> get events {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CalendarState&&(identical(other.selectedDate, selectedDate) || other.selectedDate == selectedDate)&&const DeepCollectionEquality().equals(other._events, _events));
}


@override
int get hashCode => Object.hash(runtimeType,selectedDate,const DeepCollectionEquality().hash(_events));
...
/// Create a copy of CalendarState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedDate = null,Object? events = null,}) {
